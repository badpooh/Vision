...
"")
        ...
        self.btn_tp_de = QPushButton(self.widget)
        self.btn_tp_de.setObjectName(u"btn_tp_de")
        self.btn_tp_de.setGeometry(QRect(420, 120, 75, 24))
        self.btn_sp_de = QPushButton(self.widget)
        self.btn_sp_de.setObjectName(u"btn_sp_de")
        self.btn_sp_de.setGeometry(QRect(630, 120, 75, 24))
    ...
    def retranslateUi(self, setup_ip):
        ...
        self.btn_tp_de.setText(QCoreApplication.translate("setup_ip", u"T.P Del", None))
        self.btn_sp_de.setText(QCoreApplication.translate("setup_ip", u"S.P Del", None))

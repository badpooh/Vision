...
class SetupTest(QObject):
	...
	def setup_ocr_process(self, base_save_path, search_pattern, roi_keys, except_address, access_address, setup_answer_key, template_path, roi_mask, modbus_ref, ref_select=0, refresh=None, coordinates=None, modbus_unit=None, compare_exc=None):
		sm_condition = False
		"""
		Args:
	...
	def config_setup_action(self,
		...
		if (roi_keys and except_addr and access_address and setup_answer_key and template_path and roi_mask
	...
	def setup_meter_s_m_curr(self, base_save_path, search_pattern):
		...
		self.setup_ocr_process(base_save_path, search_pattern, roi_keys, except_addr, access_address=ConfigMap.addr_measurement_setup_access.value, setup_answer_key=ref_value, ref_select=ref_select, modbus_ref=modbus_ref, template_path=template_path, roi_mask=roi_mask)
	...
	def m_s_network_rs485(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][0],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][1],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][2],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][3],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][4],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][5],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][6],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_bit_rate,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_bit_rate_2.value[1][7],
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_parity_2.value[1][0],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_parity,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_parity_2.value[1][1],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_parity,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_parity_2.value[1][2],
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_stop_bit_2.value[1][0],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_stop_bit,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			setup_answer_key=ConfigROI.s_stop_bit_2.value[1][1],

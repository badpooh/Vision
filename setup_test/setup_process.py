...
class SetupTest(QObject):
	...
	def setup_ocr_process(self, base_save_path, search_pattern, roi_keys, except_address, access_address, ref_value, template_path, roi_mask, modbus_ref, ref_select=0, refresh=None, coordinates=None, modbus_unit=None, compare_exc=None):
		...
		elif ref_select == 3 or ref_select == 4:
	...
	def m_s_meas_power(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_phase_power_calculation_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_phase_power_calculation_2.value[1]['Fundamental'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_phase_power_calculation,
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_phase_power_calculation_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_phase_power_calculation_2.value[1]['RMS'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_phase_power_calculation.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path)
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_total_power_calculation_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_total_power_calculation_2.value[1]['Arithmetic Sum'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_total_power_calculation,
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_total_power_calculation_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_total_power_calculation_2.value[1]['Vector Sum'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
			roi_mask=ConfigROI.mask_m_s_meas_total_power_calculation.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path)
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_pf_sign_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_pf_sign_2.value[1]['Unsigned'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_pf_sign,
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_pf_sign_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_pf_sign_2.value[1]['Signed'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_pf_sign.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path)
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_pf_value_at_noload_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_pf_value_at_noload_2.value[1]['PF = 0'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_pf_value_at_no_load,
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_pf_value_at_noload_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_pf_value_at_noload_2.value[1]['PF = 1'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
			roi_mask=ConfigROI.mask_m_s_meas_pf_value_at_noload.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path)
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_reactive_power_sign_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_reactive_power_sign_2.value[1]['Unsigned'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_reactive_power_sign,
			access_address=ConfigMap.addr_measurement_setup_access.value,
			ref_value=list(ConfigROI.s_reactive_power_sign_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_reactive_power_sign_2.value[1]['Signed'],
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_reactive_power_sign.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path)
	...
	def m_s_event_dip(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_dip_trigger_2.value[1][1])[1],
			ref_select=3,
			modbus_ref=ConfigROI.s_dip_trigger_2.value[1][1]['Enable'],
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_dip,
			access_address=ConfigMap.addr_dip_setup_access.value,
			ref_value=list(ConfigROI.s_dip_trigger_2.value[1][1])[0],
			ref_select=3,
			modbus_ref=ConfigROI.s_dip_trigger_2.value[1][1]['Disable'],
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_dip_setup_access.value,
			ref_value=list(ConfigROI.s_dip_threshold_2.value[1][1])[0],
			ref_select=4,
			modbus_ref=ConfigROI.s_dip_threshold_2.value[1][1][0],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_dip_threshold,
			access_address=ConfigMap.addr_dip_setup_access.value,
			ref_value=list(ConfigROI.s_dip_threshold_2.value[1][1])[1],
			ref_select=4,
			modbus_ref=ConfigROI.s_dip_threshold_2.value[1][1][1],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
			roi_mask=ConfigROI.mask_m_s_event_dip_threshold.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_dip_setup_access.value,
			ref_value=list(ConfigROI.s_dip_hysteresis_2.value[1][1])[0],
			ref_select=4,
			modbus_ref=ConfigROI.s_dip_hysteresis_2.value[1][1][0],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_dip_hysteresis,
			access_address=ConfigMap.addr_dip_setup_access.value,
			ref_value=list(ConfigROI.s_dip_hysteresis_2.value[1][1])[1],
			ref_select=4,
			modbus_ref=ConfigROI.s_dip_hysteresis_2.value[1][1][1],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
			roi_mask=ConfigROI.mask_m_s_event_dip_hysteresis.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_dip_3phase_dip_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_dip_3phase_dip_2.value[1]['Enable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_3phase_dip,
			access_address=ConfigMap.addr_3phase_dip_setup_access.value,
			ref_value=list(ConfigROI.s_dip_3phase_dip_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_dip_3phase_dip_2.value[1]['Disable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
			roi_mask=ConfigROI.mask_m_s_event_3dip_trigger.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
	...
	def m_s_event_swell(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			ref_select=3,
			modbus_ref=ConfigROI.s_swell_trigger_2.value[1][1]['Enable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_swell,
			access_address=ConfigMap.addr_swell_setup_access.value,
			ref_value=list(ConfigROI.s_swell_trigger_2.value[1][1])[0],
			ref_select=3,
			modbus_ref=ConfigROI.s_swell_trigger_2.value[1][1]['Disable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
			roi_mask=ConfigROI.mask_m_s_event_swell_trigger.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_swell_setup_access.value,
			ref_value=list(ConfigROI.s_swell_threshold_2.value[1][1])[0],
			ref_select=4,
			modbus_ref=ConfigROI.s_swell_threshold_2.value[1][1][0],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_swell_threshold,
			access_address=ConfigMap.addr_swell_setup_access.value,
			ref_value=list(ConfigROI.s_swell_threshold_2.value[1][1])[1],
			ref_select=4,
			modbus_ref=ConfigROI.s_swell_threshold_2.value[1][1][1],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
			roi_mask=ConfigROI.mask_m_s_event_swell_threshold.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_swell_setup_access.value,
			ref_value=list(ConfigROI.s_swell_hysteresis_2.value[1][1])[0],
			ref_select=4,
			modbus_ref=ConfigROI.s_swell_hysteresis_2.value[1][1][0],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_swell_hysteresis,
			access_address=ConfigMap.addr_swell_setup_access.value,
			ref_value=list(ConfigROI.s_swell_hysteresis_2.value[1][1])[1],
			ref_select=4,
			modbus_ref=ConfigROI.s_swell_hysteresis_2.value[1][1][1],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
			roi_mask=ConfigROI.mask_m_s_event_swell_hysteresis.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
	...
	def m_s_event_pq_curve(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_pq_curve_semi_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_pq_curve_semi_2.value[1]['Enable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_semi,
			access_address=ConfigMap.addr_semi_event_setup_access.value,
			ref_value=list(ConfigROI.s_pq_curve_semi_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_pq_curve_semi_2.value[1]['Disable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
			roi_mask=ConfigROI.mask_m_s_event_pq_curve_semi.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_pq_curve_iec_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_pq_curve_iec_2.value[1]['Enable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_iec,
			access_address=ConfigMap.addr_iec_event_setup_access.value,
			ref_value=list(ConfigROI.s_pq_curve_iec_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_pq_curve_iec_2.value[1]['Disable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
			roi_mask=ConfigROI.mask_m_s_event_pq_curve_iec.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_pq_curve_itic_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_pq_curve_itic_2.value[1]['Enable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_max.value,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_itic,
			access_address=ConfigMap.addr_itic_event_setup_access.value,
			ref_value=list(ConfigROI.s_pq_curve_itic_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_pq_curve_itic_2.value[1]['Disable'],
			template_path=ConfigImgRef.img_ref_meter_setup_event_min.value,
			roi_mask=ConfigROI.mask_m_s_event_pq_curve_itic.value,
			search_pattern=search_pattern,
			base_save_path=base_save_path,
	...
	def m_s_network_rs485(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			access_address=ConfigMap.addr_rs485_setup_access.value,
			ref_value=ConfigROI.s_stop_bit_2.value[1][0],
			modbus_ref=ConfigROI.s_stop_bit_2.value[1][0],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
			roi_mask=ConfigROI.mask_m_s_meas_min_meas_secondary_vol.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_stop_bit,
			access_address=ConfigMap.addr_rs485_setup_access.value,
			ref_value=ConfigROI.s_stop_bit_2.value[1][1],
			modbus_ref=ConfigROI.s_stop_bit_2.value[1][1],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
			roi_mask=ConfigROI.mask_m_s_meas_min_meas_secondary_vol.value,
			search_pattern=search_pattern,
	...
	def m_s_network_advanced(self, base_save_path, search_pattern):
		...
		self.config_setup_action(
			...
			ref_value=ConfigROI.s_modbus_timeout_2.value[1][0],
			modbus_ref=ConfigROI.s_modbus_timeout_2.value[1][0],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
			roi_mask=ConfigROI.mask_m_s_meas_min_meas_secondary_vol.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_modbus_timeout_setup_access,
			access_address=ConfigMap.addr_modbus_timeout.value,
			ref_value=ConfigROI.s_modbus_timeout_2.value[1][1],
			modbus_ref=ConfigROI.s_modbus_timeout_2.value[1][1],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_min.value,
			roi_mask=ConfigROI.mask_m_s_meas_min_meas_secondary_vol.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_rstp_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_rstp_2.value[1]['Enable'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_rstp,
			access_address=ConfigMap.addr_rstp_setup_access.value,
			ref_value=list(ConfigROI.s_rstp_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_rstp_2.value[1]['Disable'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_storm_control_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_storm_control_2.value[1]['Disable'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_rs485_map_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_rs485_map_2.value[1]['Accura 7500'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_rs485_map,
			access_address=ConfigMap.addr_rs485_map_setup_access.value,
			ref_value=list(ConfigROI.s_rs485_map_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_rs485_map_2.value[1]['Accura 7300'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			ref_value=list(ConfigROI.s_remote_control_lock_mode_2.value[1])[1],
			ref_select=1,
			modbus_ref=ConfigROI.s_remote_control_lock_mode_2.value[1]['Always Unlock'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,
		...
		self.config_setup_action(
			...
			except_addr=ConfigMap.addr_remote_control_lock_mode,
			access_address=ConfigMap.addr_remote_control_lock_mode_access.value,
			ref_value=list(ConfigROI.s_remote_control_lock_mode_2.value[1])[0],
			ref_select=1,
			modbus_ref=ConfigROI.s_remote_control_lock_mode_2.value[1]['Each Connection Lock'],
			modbus_unit=None,
			template_path=ConfigImgRef.img_ref_meter_setup_meas_max.value,
			roi_mask=ConfigROI.mask_m_s_meas_wiring.value,
			search_pattern=search_pattern,

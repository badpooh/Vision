...
class test:
    ...
    def test001(self):
        image_path = r"C:\rootech\AutoProgram\Vision\image_test\mea_voltage.png"
        roi_keys = [ConfigROI.s_modbus_timeout_1, ConfigROI.s_modbus_timeout_2, ConfigROI.s_rstp_1, 
                    ConfigROI.s_rstp_2, ConfigROI.s_storm_control_1, ConfigROI.s_storm_control_2, ConfigROI.s_rs485_map_1, ConfigROI.s_rs485_map_2, ConfigROI.s_remote_control_lock_mode_1,  ConfigROI.s_remote_control_lock_mode_2
        ...
        print(ocr_results)
        # temp_ocr = PaddleOCR(lang='en')
        # temp_ocr.export_paddlex_config_to_yaml("./my_ocr_config.yaml")

        # print("my_ocr_config.yaml 파일이 생성되었습니다.")
